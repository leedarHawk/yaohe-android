...
public class FujinShopTownAdapter extends BaseAdapter {
	...
	public FujinShopTownAdapter(Context activity, Handler handler,
			List<String> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.textView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				data.putInt(
						IntentKeyNames.KEY_POPUP_WINDOW_SELECTED_TOWN_INDEX,
						position);
				msg.setData(data);
				msg.what = 3;
