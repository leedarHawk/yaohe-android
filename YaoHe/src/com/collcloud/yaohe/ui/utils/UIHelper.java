...
public class UIHelper {
	...
	public static void clearAppCache(Activity activity) {
		final AppApplacation ac = (AppApplacation) activity.getApplication();
	...
	public static OnFocusChangeListener etOnFocusListener = new OnFocusChangeListener() {
