package com.collcloud.yaohe.activity.business.mymsg;
...
import com.collcloud.yaohe.activity.person.pinglun.PersonShopCommentActivity;
 ...
 */
public class BusinessMyMsgActivity extends BaseActivity implements
		OnClickListener {
	...
	private void getYaoeDianping() {
		progressbar(BusinessMyMsgActivity.this, R.layout.loading_progress);
	...
	private void setYaoheCommentData() {
		mAdapter = new PersonPinglunAdapter(BusinessMyMsgActivity.this, mDatas);
	...
	private void intialSource() {
		...
		LinearLayout topCancle = (LinearLayout) findViewById(R.id.ll_tv_actionbarback);
		topCancle.setOnClickListener(this);

		this.tv_actionbartitle = (TextView) findViewById(R.id.tv_actionbartitle);
		tv_actionbartitle.setText("消息");
		...
		mXListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				intent.setClass(BusinessMyMsgActivity.this,
	...
	protected void resetLayout() {
		RelativeLayout rl_mymsg = (RelativeLayout) findViewById(R.id.rl_mymsg_root);
		SupportDisplay.resetAllChildViewParam(rl_mymsg);
		...
		mTvEmptyTips.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				baseStartActivity(new Intent(BusinessMyMsgActivity.this,
						MainActivity.class));
				finish();
			}
		});
