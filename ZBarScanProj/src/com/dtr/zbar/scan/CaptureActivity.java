...
public class CaptureActivity extends Activity {
	...
	private void findViewById() {
		View ll_fanhui =  this.findViewById(R.id.ll_fanhui);
		ll_fanhui.setOnClickListener(new OnClickListener() {
...
//		}.start();
	...
	private void dealScanResult(final String msg) {
